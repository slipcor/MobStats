...
public class TextFormatter {
    ...
    public static void send(CommandSender sender, TextComponent... components) {
        if (sender instanceof Player) {
            ...
            MobStats.getInstance().getLogger().info(result.toString());
        }
    }
    ...
    public static void explainDisableOPMessages(CommandSender sender) {
        ...
        String command = "/mobstats config set " + Config.Entry.OTHER_OP_MESSAGES.getNode() + " false";
    ...
    public static void explainIgnoredWorld(Entity player) {
        ...
        message.add(new TextComponent(NameHandler.getName(player)).setColor(ChatColor.YELLOW));
        ...
        message.add(new TextComponent(Config.Entry.IGNORE_WORLDS.getNode()).setColor(ChatColor.AQUA)
                ...
                ).setCommand("/mobstats config remove " + Config.Entry.IGNORE_WORLDS.getNode() + " " + world));
        message.add(new TextComponent(" to adjust this."));

        MobStats.getInstance().sendPrefixedOP(Collections.singletonList(player),
