...
public class Debugger {
    ...
    private static Logger getGlobalLogger() {
        if (logger == null) {
            ...
            try {
                ...
                final File debugFolder = new File(MobStats.getInstance().getDataFolder(), "debug");
                ...
                MobStats.getInstance().getLogger().log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void load(final MobStats instance, final CommandSender sender) {
        check.clear();
        strings.clear();
        override = false;
