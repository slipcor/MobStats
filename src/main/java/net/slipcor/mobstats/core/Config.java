package net.slipcor.mobstats.core;
...
public class Config {
    ...
    public enum Entry {
        ...
        MYSQL_TABLE(String.class, "MySQL.table", "mobstats", new String[]{
                "# general statistic table name"}),
        MYSQL_KILLTABLE(String.class, "MySQL.killtable", "mobkillstats", new String[]{
        ...
        SQLITE_TABLE(String.class, "SQLite.table", "mobstats", new String[]{
                "# general statistic table name"}),
        SQLITE_KILLTABLE(String.class, "SQLite.killtable", "mobkillstats", new String[]{
                "# kill statistic table name"}),

        YML(Null.class, "YML", null, new String[]{
                "# === [ YML Database Emulation Settings ] ==="}),
        YML_TABLE(String.class, "YML.table", "mobstats", new String[]{
                "# general statistic file name, plugin will append extension '.yml'"}),
        YML_KILLTABLE(String.class, "YML.killtable", "mobkillstats", new String[]{
        ...
        STATISTICS_COLLECT_PRECISE(Boolean.class, "statistics.collectPrecise", false, new String[]{
        ...
        STATISTICS_COUNT_MOB_VS_MOB(Boolean.class, "statistics.countMobVsMob", true, new String[]{
        ...
        STATISTICS_KD_SIMPLE(String.class, "statistics.killDeathSimple", true, new String[]{
        ...
        STATISTICS_PURGE_MOBS_ON_START(Boolean.class, "statistics.purgeMobsOnStart", true, new String[]{
                "# clear old mob entries on every start"}),
        STATISTICS_PURGE_MOBS_DAYS(Boolean.class, "statistics.purgeMobsDays", 1, new String[]{
        ...
        OTHER_MOBARENA(Boolean.class, "other.MobArena", false, new String[]{"# count Mob Arena kills/deaths"}),
        ...
        try {
            ...
            while ((stringLine = reader.readLine()) != null) {
                ...
                if (key == null && writer.toString().length() < 1) {
                    writer.append("# === [ Mob Stats Config ] ===");
                    writer.newLine();
                }
