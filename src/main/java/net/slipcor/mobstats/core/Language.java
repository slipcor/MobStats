...
public enum Language {
    ...
    HEAD_HEADLINE("head.headline", "&cMob Stats Top &7%0% &c%1%"),
    ...
    MSG_DISPLAY_CREATED("msg.display_created", "Mob Leaderboard created at %0%!"),
    ...
    MSG_PREFIX("msg.prefix", "[Mob Stats] "),
    ...
    public static boolean load(final FileConfiguration cfg) {
        ...
        for (Language lang : Language.values()) {
            if (cfg.get(lang.node) == null) {
                ...
                MobStats.getInstance().getLogger().info("New Node: " + lang.node);
                changed = true;
            } else {
